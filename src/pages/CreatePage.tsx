...
const BACKGROUND_IMAGES = [
  'https://picsum.photos/seed/tech5/1920/1080',
  'https://picsum.photos/seed/tech6/1920/1080',
  'https://picsum.photos/seed/tech7/1920/1080',
  'https://picsum.photos/seed/tech8/1920/1080'
];

export default function CreatePage({ onLogin }: { onLogin: (u: UserType) => void }) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success) {
        onLogin({ id: data.id, username: formData.username });
        navigate('/dashboard');
      } else {
    ...
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      >
        <div className="text-center mb-10">
          ...
          <h2 className="text-3xl font-black tracking-tighter mb-2">Join NEXA</h2>
          <p className="text-white/40">Create your administrator account</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          >
            {loading ? <Loader2 className="animate-spin" /> : <>Create Account <ChevronRight size={20} /></>}
          </button>
        </form>
        ...
        <div className="mt-8 text-center">
          <p className="text-white/40 text-sm">
            ...
            <Link to="/login" className="text-green-500 font-bold hover:underline">Sign In</Link>
          </p>
        </div>
      </motion.div>
    </div>
